 ...
 */
export function loadArrow(path: string, options?: LoadOptions & import("../format/types.js").ArrowOptions): Promise<ColumnTable>;
/**
 ...
 */
export function loadCSV(path: string, options?: LoadOptions & import("./from-csv.js").CSVParseOptions): Promise<ColumnTable>;
/**
 ...
 */
export function loadFixed(path: string, options?: LoadOptions & import("./from-fixed.js").FixedParseOptions): Promise<ColumnTable>;
/**
 ...
 */
export function loadJSON(path: string, options?: LoadOptions & import("./from-json.js").JSONParseOptions): Promise<ColumnTable>;
